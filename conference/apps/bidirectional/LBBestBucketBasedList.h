#ifndef LBBESTBUCKETBASEDLIST_H
#define LBBESTBUCKETBASEDLIST_H
...
void LBBestBucketBasedList<state, environment, dataStructure, criterion>::computeBestBucket(double gLim_,
	...
	if (criterion == MinCriterion::MinTot){
		optCount = std::min({gCount, fCount, dCount, bCount, rfCount, rdCount, fgCount, dgCount, bgCount, frdCount, rfdCount, rfgCount, rdgCount, rfrdCount, frdgCount, rfdgCount,rfrdgCount});
	} else if (criterion == MinCriterion::MaxTot){
		optCount = std::max({gCount, fCount, dCount, bCount, rfCount, rdCount, fgCount, dgCount, bgCount, frdCount, rfdCount, rfgCount, rdgCount, rfrdCount, frdgCount, rfdgCount,rfrdgCount});
	}
	m_optCount = optCount;
